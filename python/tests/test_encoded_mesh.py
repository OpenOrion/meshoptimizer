...
import numpy as np
import unittest
from meshoptimizer import Mesh, EncodedMesh, encode_mesh, decode_mesh
...
class TestEncodedMesh(unittest.TestCase):
    ...
    def test_mesh_encode_decode_with_encoded_mesh(self):
        """Test that the Mesh.encode and Mesh.decode methods work with EncodedMesh."""
        ...
        # Decode the mesh using the Mesh.decode method without providing size information
    ...
    def test_backward_compatibility(self):
        """Test that the old dictionary format still works."""
        # Encode the mesh using the old dictionary format
        encoded_data = {
            'vertices': encode_mesh(self.vertices, self.indices).vertices,
            'indices': encode_mesh(self.vertices, self.indices).indices
        }
        
        # Decode the mesh using the Mesh.decode method with size information
